-- ══════════════════════════════════════════════════════════════════
-- VIBIN APPAREL — FINAL DATABASE SCHEMA (Fixes existing table errors)
...
-- ══════════════════════════════════════════════════════════════════
-- DROP ALL EXISTING TABLES (comment out any that don't exist yet)
-- ══════════════════════════════════════════════════════════════════

-- Uncomment these if you want to start fresh (will delete ALL data!)
...
-- ══════════════════════════════════════════════════════════════════
-- 1. PRODUCTS TABLE (if not exists)
-- ══════════════════════════════════════════════════════════════════
...
DROP POLICY IF EXISTS "Anyone can sign up" ON vibin_signups;
...
DROP POLICY IF EXISTS "Ambassadors view own" ON ambassadors;
CREATE POLICY "Ambassadors view own" ON ambassadors FOR SELECT USING (true);
DROP POLICY IF EXISTS "Anyone can apply ambassador" ON ambassadors;
...
DROP POLICY IF EXISTS "Ambassadors view referrals" ON ambassador_referrals;
CREATE POLICY "Ambassadors view referrals" ON ambassador_referrals FOR SELECT USING (true);
...
DROP POLICY IF EXISTS "Anyone can create chat" ON support_chats;
CREATE POLICY "Anyone can create chat" ON support_chats FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Users view own chats" ON support_chats;
...
DROP POLICY IF EXISTS "Anyone can send message" ON support_messages;
CREATE POLICY "Anyone can send message" ON support_messages FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Users view messages" ON support_messages;
...
DROP POLICY IF EXISTS "Anyone can create request" ON verification_requests;
CREATE POLICY "Anyone can create request" ON verification_requests FOR INSERT WITH CHECK (true);
...
-- ══════════════════════════════════════════════════════════════════
-- DONE! All 11 tables created/updated.
-- ══════════════════════════════════════════════════════════════════
